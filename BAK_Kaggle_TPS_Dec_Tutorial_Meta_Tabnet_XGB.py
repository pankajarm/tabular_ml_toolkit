...
#fit and predict
_, tabnet_oof_model_test_preds, tabnet_oof_model_preds = tmlt.do_kfold_train_preds(n_splits=3, model=tabnet_model, X = X_np, y = y_np, oof=True, X_test = X_test_np,
...
# k-fold training
xgb_model_metrics_score, xgb_model_test_preds, _ = tmlt.do_kfold_train_preds(X_np, y_np, X_test=X_test_np, n_splits=5,model=xgb_model, val_metric=accuracy_score, eval_metric='mlogloss')
...
submission_file_name = 'wed_dec_29_1752_submission.csv'
